...
import fi.tieto.teco.demo.config.audit.AuditEventConverter;
import fi.tieto.teco.demo.domain.PersistentAuditEvent;
...
import static fi.tieto.teco.demo.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
